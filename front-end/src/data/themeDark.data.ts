...
export const darkTheme: Theme = {
    colors: {
        primary: "#1E1E1E", // Cor principal para o modo escuro
        secondary: "#333333", // Cor secundária para o modo escuro
        background: "#121212", // Cor de fundo para o modo escuro
        text: "#E0E0E0", // Cor do texto para o modo escuro
        accent: "#BB86FC" // Cor de destaque para o modo escuro
    },
    typography: {
        fontFamily: "'Roboto', sans-serif", // Família de fontes para o modo escuro
        fontSize: {
    ...
    borders: {
        ...
        color: "#333333" // Cor da borda
    },
    shadows: {
        small: "0 2px 4px rgba(0, 0, 0, 0.5)", // Sombra pequena
        medium: "0 4px 8px rgba(0, 0, 0, 0.5)", // Sombra média
        large: "0 8px 16px rgba(0, 0, 0, 0.5)" // Sombra grande
    },
    sizes: {
